...
import WeatherForecastIconComponent from "./components/WeatherIcon/WeatherIcon.jsx";
import WeatherForecastComponent from "./components/WeatherForecast/WeatherForecast.jsx";
...
const App = () => {
  return (
    <>
      <h1 className="local-weather-title">Local Weather</h1>
      <section>
        {weatherForecasts.map((forecast, index) => (
          <WeatherForecastComponent key={index} weatherForecast={forecast} />
        ))}
      </section>
    </>
  );
